...
const DeliveryForm = () => {
  ...
  const pickup = draftOrder?.delivery_option?.pickup_station
    ? JSON.parse(draftOrder?.delivery_option?.pickup_station)?.name
    : null;
            ...
            <FormControlLabel
              ...
              control={
                <Radio
                  ...
                  checked={
                    draftOrder?.delivery_option?.delivery_method ==
                    "Pickup Station"
                  }
